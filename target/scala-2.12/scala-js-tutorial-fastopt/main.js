...
function $s_Lwebpage_HelloJSWorld__main__AT__V(args) {
  $m_Lwebpage_HelloJSWorld$().main__AT__V(args)
}
/** @constructor */
function $c_Lwebpage_HelloJSWorld$() {
  /*<skip>*/
}
$c_Lwebpage_HelloJSWorld$.prototype = new $h_O();
$c_Lwebpage_HelloJSWorld$.prototype.constructor = $c_Lwebpage_HelloJSWorld$;
/** @constructor */
function $h_Lwebpage_HelloJSWorld$() {
  /*<skip>*/
}
$h_Lwebpage_HelloJSWorld$.prototype = $c_Lwebpage_HelloJSWorld$.prototype;
$c_Lwebpage_HelloJSWorld$.prototype.main__AT__V = (function(args) {
  ...
  this.appendParagraph__Lorg_scalajs_dom_Node__T__V(document.getElementById("content"), "This is a new paragraph.");
  this.drawToCanvas__Lorg_scalajs_dom_HTMLCanvasElement__V(document.getElementById("canvas"))
});
$c_Lwebpage_HelloJSWorld$.prototype.appendParagraph__Lorg_scalajs_dom_Node__T__V = (function(target, text) {
  var p = document.createElement("p");
  var textNode = document.createTextNode(text);
  p.appendChild(textNode);
  target.appendChild(p)
});
$c_Lwebpage_HelloJSWorld$.prototype.drawToCanvas__Lorg_scalajs_dom_HTMLCanvasElement__V = (function(canvas) {
  var context = canvas.getContext("2d");
  context.fillRect(100.0, 100.0, 200.0, 150.0)
});
var $d_Lwebpage_HelloJSWorld$ = new $TypeData().initClass({
  Lwebpage_HelloJSWorld$: 0
}, false, "webpage.HelloJSWorld$", {
  Lwebpage_HelloJSWorld$: 1,
  O: 1
});
$c_Lwebpage_HelloJSWorld$.prototype.$classData = $d_Lwebpage_HelloJSWorld$;
var $n_Lwebpage_HelloJSWorld$;
function $m_Lwebpage_HelloJSWorld$() {
  if ((!$n_Lwebpage_HelloJSWorld$)) {
    $n_Lwebpage_HelloJSWorld$ = new $c_Lwebpage_HelloJSWorld$()
  };
  return $n_Lwebpage_HelloJSWorld$
}
/** @constructor */
...
doClickStuff = (function() {
  ...
  var this$4 = $n($as_Ljava_io_PrintStream($n(this$3.s_Console$__f_outVar).s_util_DynamicVariable__f_v));
  this$4.java$lang$JSConsoleBasedPrintStream$$printString__T__V("Button clicked.\n")
});
$s_Lwebpage_HelloJSWorld__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
